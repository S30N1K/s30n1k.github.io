...
var listToStyles = __webpack_require__(/*! ./listToStyles */ 339)
...
module.exports = __webpack_require__(/*! C:\dev\PointDebugger\src\main.js */330);
...
var _vue = __webpack_require__(/*! vue/dist/vue */ 331);
...
var PointJS = __webpack_require__(/*! exports-loader?PointJS!./vendor/point.0.4.0 */ 335);
...
stats.setAttribute(':pjs', "pjs");

PointJS = function (e) {
    return function () {
        console.info('PointDebugger loaded!');

        e.apply(this, arguments);

        // Проверка вхождения курсора в обьект
        this.mouseControl.isObject = function (object) {
        ...
        new _vue2.default({
            el: '#app',
            components: {
                stats: __webpack_require__(/*! ./components/stats.vue */ 336)
            },
            data: {
                pjs: pjs
            }
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(/*! ./../../webpack/buildin/global.js */ 50), __webpack_require__(/*! ./../../timers-browserify/main.js */ 332).setImmediate))
...
__webpack_require__(/*! setimmediate */ 333);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(/*! ./../webpack/buildin/global.js */ 50), __webpack_require__(/*! ./../process/browser.js */ 334)))
...
/* 335 */
/*!*************************************************************************!*\
  !*** ./node_modules/exports-loader?PointJS!./src/vendor/point.0.4.0.js ***!
  \*************************************************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
function PointJS(da, ea, rb, Gc) {
    ...
    var h = window,
        ...
        la = 1,
        e = { x: 0, y: 0 },
        r = { fillStyle: "black", strokeStyle: "black", globalAlpha: 1, font: "sans-serif", textBaseline: "top" },
        Z = function Z(a) {
        console.log("[PointJS] : ", a);
    };
    "undefined" !== typeof POINTJS_USER_LOG && (Z = POINTJS_USER_LOG);
    ...
    this.system.consoleLog = function (a) {
        this.log = !0 === a ? console.log : Z;
    };
    this.system.setTitle = function (a) {
        h.document.title = a;
    };
    this.system.setSettings = function (a) {
        Ba = u(a.isShowError) ? a.isShowError : !0;
        sb = u(a.isStopForError) ? a.isStopForError : !0;
        Ob = u(a.isAutoClear) ? a.isAutoClear : !1;
        u(a.isZBuffer);
    };
    ...
    this.system.setSmoothing = function (a) {
        Ca = a;
        k.msImageSmoothingEnabled = Ca;
        k.imageSmoothingEnabled = Ca;
    };
    var tc = {
    ...
    this.modules["import"] = function (a, b) {
        ...
        c.onload = function () {
            var a = {
                ...
                g = c.responseText.toString().replace(/PointJS.Module/i, "Module.constructor");
            new Function("Module", g)(a);
            a = new a.constructor(C, h);
            x.load();
            b(a);
        };
        c.send();
    ...
    var f = function f(a, b, c) {
        ...
        if (c) {
            ...
            var g = Math.cos(d);
            d = Math.sin(d);
            return f(c * g - a * d + b.x, c * d + a * g + b.y);
        }
        return f(a.x, a.y);
    },
        Da = function Da(a, b) {
        ...
        var g = 0;
        var e = b.length;
        for (c = b.length - 1; g < e; c = g++) {
            b[g].y > a.y !== b[c].y > a.y && a.x < (b[c].x - b[g].x) * (a.y - b[g].y) / (b[c].y - b[g].y) + b[g].x && (d = !d);
        }return d;
    },
        Ea = function Ea(a, b, c) {
        return !(a < b || a > c);
    };
    this.vector.isNumInRange = Ea;
    this.vector.point = f;
    this.vector.simplePoint = function (a, b, c) {
        return { x: !1 !== a ? a : !1, y: !1 !== b ? b : !1, z: !1 !== c ? c : !1 };
    };
    this.vector.v2d = f;
    this.vector.size = E;
    this.vector.getPointAngle = H;
    this.vector.isPointIn = ma;
    this.vector.pointMinus = function (a, b) {
        return { x: a.x - b.x, y: a.y - b.y, z: a.z - b.z };
    };
    this.vector.pointPlus = Ra;
    ...
    this.vector.getMidPoint = function (a, b) {
        return u(b) ? f((a.x + b.x) / 2, (a.y + b.y) / 2) : 0;
    };
    ...
    this.vector.getAngle2Points = Da;
    ...
    this.vector.moveCollision = function (a, b, c, d, g, e) {
        var f = !1,
            k = !1,
            h = c.abs(),
            A = a.getStaticBoxPosition(),
            m = b.length - 1,
            n;
        var p = 2 + h.x;
        for (n = 2 + h.y; 0 <= m; m--) {
            if (h = b[m], h.visible && a !== h && !(g && !h.isInCameraStatic() || e && a.getDistanceC(h.getPositionC()) > e) && a.isStaticIntersect(h.getStaticBox())) {
                var l = h.getStaticBoxPosition();
                A.h >= l.y + n && A.y <= l.h - n && (0 <= c.x ? Ea(A.w, l.x, l.w) && (a.x = l.x - (a.w + a.box.w + a.box.x) + 1, c.x = 0, f = !0) : 0 > c.x && Ea(A.x, l.x, l.w) && (a.x = l.w - a.box.x - 1, c.x = 0, f = !0));
                A.w >= l.x + p && A.x <= l.w - p && (0 < c.y ? Ea(A.h, l.y, l.h) && (a.y = l.y - (a.h + a.box.h + a.box.y) + 1, c.y = 0, k = !0) : 0 > c.y && Ea(A.y, l.y, l.h) && (a.y = l.h - a.box.y - 1, c.y = 0, k = !0));
                d && d(a, h, f, k);
            }
        }a.move(c);
    };
    this.vector.moveCollisionAngle = function (a, b, c, d, g, e, k) {
        var h = f();
        g = math.a2r(OOP.isDef(g) ? g : a.angle);
        h.x = c * Math.cos(g);
        h.y = c * Math.sin(g);
        c = 0;
        g = b.length;
        for (var A; c < g; c += 1) {
            if (A = b[c], !e || A.isInCamera()) if (!k || !a.getDistanceC(A.getPositionC())) {
                var l = A.getStaticBox();
                if (a.isIntersect(A)) {
                    var m = a.getStaticBox(),
                        n = Math.abs(h.x),
                        Sa = Math.abs(h.y);
                    m.x + m.w > l.x + 10 + n && m.x < l.x + l.w - 10 - n && (0 < h.y && m.y + m.h < l.y + l.h / 2 + Sa ? h.y = 0 : 0 > h.y && m.y > l.y + l.h - l.h / 2 - Sa && (h.y = 0));
                    m.y + m.h > l.y + 10 + Sa && m.y < l.y + l.h - 10 - Sa && (0 < h.x && m.x + m.w < l.x + l.w / 2 + n ? h.x = 0 : 0 > h.x && m.x > l.x + l.w - l.w / 2 - n && (h.x = 0));
                    d && d(a, A);
                }
            }
        }a.move(h);
    ...
    var Qb = function Qb(a, b) {
        ...
        d.height = g.height;
        d.zIndex = g.zIndex + a;
        b && (d.opacity = Qb(b.alpha, 1), d.backgroundColor = Qb(b.backgroundColor, "transparent"));
        p.attach(c);
        (this.context = c.getContext("2d")).textBaseline = r.textBaseline;
        this.isAutoClear = !0;
        this.clear = function () {
        ...
        t(vb, function (a) {
            ...
            a.context.textBaseline = r.textBaseline;
        });
    },
        vc = function vc() {
        t(vb, function (a) {
    ...
    var Sb = 0,
        ...
        loaded: !1, events: {
            onload: [],
            preLoop: [], postLoop: [], gameBlur: [], gameFocus: [], gameResize: []
        }, addEvent: function addEvent(a, b, c) {
            "onload" === a && p.loaded ? c() : p.events[a].push({ id: b, func: c });
        }, delEvent: function delEvent(a, b) {
            t(p.events[a], function (a, d, g) {
                a.id == b && g.splice(d, 1);
            });
        }, runEvent: function runEvent(a) {
            t(p.events[a], function (a) {
            ...
            p.loaded ? b() : p.addEvent("onload", "attachElement_PointJS" + (Sb += 1), b);
        }, remove: function remove(a) {
            var b = function b() {
                h.document.body.removeChild(a);
            };
            p.loaded ? b() : p.addEvent("onload", "attachElement_PointJS" + (Sb += 1), b);
        }, getWH: function getWH() {
            return {
                w: parseInt(h.innerWidth || h.document.body.clientWidth),
                h: parseInt(h.innerHeight || h.document.body.clientHeight)
            };
        }
    };
    ...
    this.system.newDOM = function (a, b) {
        ...
        c.style.left = 0;
        c.style.top = 0;
        c.style.zIndex = na.style.zIndex + 1;
        c.style.border = "none";
        if (b) {
            var d = function d(a) {
                a.stopPropagation();
    ...
    var k = null,
        Rb = null;
    var q = h.document.createElement("canvas");
    Rb = k = q.getContext("2d");
    k.textBaseline = r.textBaseline;
    q.crossOrigin = "anonymous";
    q.width = parseInt(da);
    q.height = parseInt(ea);
    q.style.position = "fixed";
    q.style.left = 0;
    q.style.top = 0;
    q.style.zIndex = 1E4;
    q.id = "PointJS-canvas_0";
    if ("object" === (typeof rb === "undefined" ? "undefined" : _typeof(rb))) for (var wb in rb) {
        wb.match(/margin|padding|position/) || (q.style[wb] = rb[wb]);
    ...
    p.addEvent("onload", "Window_Hide_Scroll", function () {
        h.document.body.style.overflow = "hidden";
    });
    var na = h.document.createElement("div");
    (function () {
        var a = na.style;
        a.position = "fixed";
        a.top = a.left = 0;
    ...
    this.system.setStyle = function (a) {
        if ("object" == (typeof a === "undefined" ? "undefined" : _typeof(a))) for (var b in a) {
            q.style[b] = a[b];
        }
    };
    ...
    this.system.initFullPage = function () {
        p.addEvent("gameResize", "PointJS_resizeGame", function () {
            m = p.getWH().w;
            n = p.getWH().h;
            F = m / 2;
            G = n / 2;
    ...
    var U = !1,
        wc = function wc() {
        U || (this.requestFullscreen ? (this.requestFullscreen(), U = !0) : this.mozRequestFullScreen ? (this.mozRequestFullScreen(), U = !0) : this.webkitRequestFullscreen && (this.webkitRequestFullscreen(), U = !0), m = p.getWH().w, n = p.getWH().h, F = m / 2, G = n / 2, q.width = m, q.height = n, va());
    },
        yb = function yb(a) {
        U = Tb(h.document.fullscreenElement || h.document.mozFullScreenElement || h.document.webkitFullscreenElement);
    };
    h.document.addEventListener("webkitfullscreenchange", yb);
    h.document.addEventListener("mozfullscreenchange", yb);
    h.document.addEventListener("fullscreenchange", yb);
    this.system.initFullScreen = function () {
        U || (h.document.documentElement.onclick = wc, Fa || (p.addEvent("gameResize", "PointJS_initFullScreen", function () {
            m = p.getWH().w;
            n = p.getWH().h;
            F = m / 2;
            G = n / 2;
    ...
    this.system.exitFullScreen = function () {
        U && (p.delEvent("gameResize", "PointJS_initFullScreen"), h.document.exitFullscreen ? (h.document.exitFullscreen(), U = !1) : h.document.mozCancelFullScreen ? (h.document.mozCancelFullScreen(), U = !1) : h.document.webkitExitFullscreen && (h.document.webkitExitFullscreen(), U = !1), m = da, n = ea, F = m / 2, G = n / 2, q.width = m, q.height = n, va(), h.document.documentElement.onclick = function () {});
    };
    ...
    this.system.initFullScale = function (a) {
        Fa || (a && (Wb = !0), p.addEvent("gameResize", "PointJS_initFullScale", function () {
            var a = Ub,
                c = Vb,
                d = p.getWH();
            Wb ? (a = d.w, c = d.h) : d.w < d.h ? (c = d.w / m, a = d.w, c *= n) : d.h < d.w && (a = d.h / n, c = d.h, a *= m);
            Ub = a;
            Vb = c;
            V = { w: a / m, h: c / n };
            q.style.width = a + "px";
            q.style.height = c + "px";
            va();
        }), p.runEvent("gameResize", "PointJS_initFullScale"), Fa = !0);
    };
    this.system.exitFullScale = function () {
        Fa && (Fa = !1, p.delEvent("gameResize", "PointJS_initFullScale"), q.style.width = da + "px", q.style.height = ea + "px");
    };
    ...
    var zb = !1,
        ...
        xc = {
        8: !0, 9: !0, 13: !0, 18: !0, 16: !0, 17: !0, 27: !0, 112: !0, 113: !0,
    ...
    this.keyControl.exitKeyControl = function () {
        ...
        z.clear("key:press");
        z.clear("key:up");
        p.delEvent("postLoop", "PointJS_clearAllKeyUp");
    ...
    this.keyControl.initControl = this.keyControl.initKeyControl = function () {
        ...
        h.onkeydown = function (a) {
            if (Ua) return Ia = a.keyCode, xc[a.keyCode] ? (a.preventDefault(), !1) : !0;
            a.preventDefault();
            2 != oa[a.keyCode] && (oa[a.keyCode] = 1, Va = a.keyCode, z.run("key:press", wa[a.keyCode]));
            W[a.keyCode] = !0;
            return !1;
        };
        ...
        p.addEvent("preLoop", "PointJS_KeyDownEvent", function () {
            z.isEvent("key:down") && D(W, function (a, b) {
    ...
    var Ka = !0,
        ...
        pa = f(0, 0),
        Za = !1,
        Ab = { LEFT: 1, RIGHT: 3, MIDDLE: 2 },
        Bb = { 1: "LEFT", 3: "RIGHT", 2: "MIDDLE" },
        $a = !1,
        ab = {},
        bb = {},
        La = {},
    ...
    this.mouseControl.setCursorImage = function (a) {
        a = "url('" + a + "'), auto";
        Xa != a && (Xa = a, h.document.body.style.cursor = Xa);
    };
    this.mouseControl.setVisible = function (a) {
        !Ka && !a || Ka && a || (Ka = 1 == a, h.document.body.style.cursor = Ka ? Xa : "none");
    };
    ...
    var Yb = function Yb(a) {
        ...
        db = !1,
        Zb = function Zb() {
        db && (Ya = u(h.document.pointerLockElement) || u(h.document.mozPointerLockElement) ? !0 : !1);
    };
    this.mouseControl.initMouseLock = function () {
        p.addEvent("onload", "initPointerLock", function () {
            db = na.requestPointerLock || na.mozRequestPointerLock || !1;
            h.document.exitPointerLock = h.document.exitPointerLock || h.document.mozExitPointerLock || !1;
            "onpointerlockchange" in h.document ? h.document.addEventListener("pointerlockchange", Zb, !1) : "onmozpointerlockchange" in h.document && h.document.addEventListener("mozpointerlockchange", Zb, !1);
            if (!db) return Z("error in initMouseLock : not supported");
            Ya || (na.onclick = db);
        });
    };
    ...
    this.mouseControl.initControl = this.mouseControl.initMouseControl = function () {
        ...
        h.onmousemove = function (a) {
            ...
            if (Ya) {
                ...
                v.x += a.movementX || a.mozMovementX || 0;
                v.y += b;
            } else v.x = a.pageX - xb.x, v.y = a.pageY - xb.y, V && (v.x /= V.w, v.y /= V.h);
            v.x /= ka;
            v.y /= la;
            pa.x = v.x - Wa.x;
            pa.y = v.y - Wa.y;
        ...
        h.onmousewheel = Yb;
        h.addEventListener("DOMMouseScroll", Yb, !1);
        p.addEvent("preLoop", "PointJS_MouseEventDown", function () {
            $a && z.run("mouse:down", $a);
        });
    ...
    this.touchControl.getFixPositionS = function () {
        return w.x || w.y ? f(w.x, w.y) : !1;
    };
    this.touchControl.getFixPosition = function () {
        return w.x || w.y ? f(w.x + e.x, w.y + e.y) : !1;
    };
    ...
    this.touchControl.initControl = this.touchControl.initTouchControl = function () {
        ...
        C.touchControl.vibrate = function (a) {
    ...
    this.colors.randomColor = function (a, b, c) {
        return ib(ba(a, b), ba(a, b), ba(a, b), c || 1);
    };
    this.colors.fromImage = function (a, b) {
        var c = { img: h.document.createElement("img"), color: null };
        c.img.onload = function () {
            c.color = k.createPattern(this, "repeat");
            "function" === typeof b && (c.onload = b, c.onload(), delete c.onload);
        };
        c.img.src = a;
        return c;
    };
    var u = function u(a) {
        ...
        var d, g;
        for (d in a) {
            if ((!c || a.hasOwnProperty(d)) && "undefined" !== typeof a[d] && (g = b(a[d], d, a)) && "break" === g) break;
        }
    },
        t = function t(a, b) {
        if (a.length) for (var c = a.length - 1, d; 0 <= c && ("undefined" === typeof a[c] || !(d = b(a[c], c, a) || !1) || "break" !== d); c--) {}
    };
    ...
    this.OOP.drawArr = function (a, b) {
        ...
        for (c = a.length; d < c; d += 1) {
            a[d] && a[d].draw && a[d].isInCamera() && (a[d].draw(), b && b(a[d], d));
        }
    };
    ...
    var bc = function bc(a) {
        ...
        e.onreadystatechange = function () {
            4 == e.readyState && (b(e.responseText), c && (g ? setTimeout(f, g) : f()));
        };
        this.start = function () {
    ...
    this.OOP.readJSON = function (a, b, c) {
        ...
        g.onreadystatechange = function () {
            4 == g.readyState && (d = g.responseText, c || (d = JSON.parse(d)), x.load(), b(d));
        };
        g.send();
    };
    ...
    this.OOP.forXY = function (a, b, c) {
        var d, g, e;
        for (g = 0; g < b; g += 1) {
            for (d = 0; d < a && (!(e = c(d, g)) || "break" != e); d += 1) {}
        }
    };
    this.OOP.forArr = t;
    ...
    var Bc = function Bc() {
        ...
        this.draw = function (b) {
            for (var c = a.length - 1; 0 <= c; c--) {
                a[c].isInCamera() && (a[c].draw(), b && b(a[c], c));
            }
        };
        this.update = function (b, c) {
            for (var d = a.length - 1; 0 <= d; d--) {
                c && !a[d].isInCamera() || b(a[d], d);
            }
        };
        this.add = function (b) {
            a.push(b);
    ...
    var ec = function ec() {
        return h.requestAnimationFrame || h.webkitRequestAnimationFrame || h.mozRequestAnimationFrame || h.oRequestAnimationFrame || h.msRequestAnimationFrame || function (a) {
            h.setTimeout(a, 1E3 / Oa);
        };
    },
        ya = ec(),
        fc = function fc() {
        L = Date.now();
        Ob && k.clearRect(0, 0, m, n);
        p.runEvent("preLoop");
    },
        gc = function gc() {
        p.runEvent("postLoop");
        ...
        hc = function hc() {
        M.audio && t(M.audio, function (a) {
            a.stop();
        });
    };
    this.game.newLoop = function (a, b, c, d, g) {
    ...
    this.game.newLoopFromConstructor = function (a, b) {
        C.game.newLoopFromClassObject(a, new b());
    };
    this.game.setLoopSound = function (a, b) {
        var c;
        ia[a].audio || (ia[a].audio = []);
        for (c = 0; c < b.length; c += 1) {
            ia[a].audio.length = 0, b[c].setNextPlay(b[c + 1 === b.length ? 0 : c + 1]), ia[a].audio.push(b[c]);
        }
    };
    ...
    var Eb = function Eb() {
        ...
        if (60 > Oa) {
            var a = 1E3 / Oa;
            try {
                L = Date.now(), L - dc > a && (fc(), M.func(jb), dc = L, gc());
            } catch (b) {
                Ba && Qa(b), sb && (Ba || Qa(b), ja());
            }
            ya(Eb);
            return !1;
        }
        ...
        ic = function ic(a) {
        fa || (fa = !0, Oa = a || 60, ya(Eb));
    },
        ja = function ja(a) {
        fa && (fa = !1, hc(), ya = function ya() {
            "undefined" !== typeof a && Z(a);
        });
    };
    ...
    this.game.resume = function () {
        if (!fa) return M.audio && M.audio[0].play(), ya = ec(), kb = -1, ic(), !1;
    };
    var Cc = 0,
        B = function B(a) {
        ...
        this.strokeColor = a.strokeColor || r.strokeStyle;
        ...
        this.__dataset__ = {};
        this.setShadow(a);
        "object" === _typeof(a.data) && D(a.data, function (a, c) {
            this.dataSet(c, a);
        }, !0);
    ...
    B.prototype = {
        predraw: function predraw() {}, getID: function getID() {
            return this.id;
        }, getType: function getType() {
            return this.type;
        }, dataDel: function dataDel(a) {
            delete this.__dataset__[a];
        }, dataSet: function dataSet(a, b) {
            this.__dataset__[a] = b;
        }, dataGet: function dataGet(a, b) {
            ...
            a && a.id != this.id && (a.parent = this, this.children.push(a), a.move(this.getPosition()), a.setPositionC(H(a.getPositionC(), this.getPositionC(), this.angle)), a.turn(this.angle));
        }, delChild: function delChild(a) {
            a.parent = !1;
            var b;
            var c = 0;
        ...
        }, delParent: function delParent() {
            this.parent.delChild(this);
        }, setBox: function setBox(a) {
            a.offset && (this.box.x = a.offset.x || 0, this.box.y = a.offset.y || 0);
            a.size && (this.box.w = a.size.w || 0, this.box.h = a.size.h || 0);
        }, isArrIntersect: function isArrIntersect(a) {
            var b;
            var c = 0;
            for (b = a.length; c < b; c += 1) {
                if (a[c].id !== this.id && this.isIntersect(a[c])) return a[c];
            }return !1;
        }, isArrInside: function isArrInside(a) {
            var b;
            var c = 0;
            for (b = a.length; c < b; c += 1) {
                if (this.isDynamicInside(a[c].getDynamicBox())) return a[c];
            }return !1;
        }, getNearest: function getNearest(a) {
            var b = 0,
                c = !1,
                d;
            var g = 0;
            for (d = a.length; g < d; g += 1) {
                if (this.id !== a[g].id) {
                    !1 === c && (c = this.getDistanceC(a[g].getPositionC()), b = g);
                    var e = this.getDistanceC(a[g].getPositionC());
                    e < c && (c = e, b = g);
                }
            }return a[b];
        }, setFlip: function setFlip(a, b) {
            u(a) && this.flip.x !== a && (this.flip.x = a);
            u(b) && this.flip.y !== b && (this.flip.y = b);
        }, setUserData: function setUserData(a) {
            for (var b in a) {
                u(this[b]) || (this[b] = a[b]);
            }
        ...
        }, getDynamicBox: function getDynamicBox() {
            var a = this.getPosition(1);
            return 0 === this.angle ? [f(this.x + this.box.x, this.y + this.box.y), f(this.x + this.box.x + this.w + this.box.w, this.y + this.box.y), f(this.x + this.box.x + this.w + this.box.w, this.y + this.box.y + this.h + this.box.h), f(this.x + this.box.x, this.y + this.box.y + this.h + this.box.h)] : [H(f(this.x + this.box.x, this.y + this.box.y), a, this.getAngle()), H(f(this.x + this.box.x + this.w + this.box.w, this.y + this.box.y), a, this.getAngle()), H(f(this.x + this.box.x + this.w + this.box.w, this.y + this.box.y + this.h + this.box.h), a, this.getAngle()), H(f(this.x + this.box.x, this.y + this.box.y + this.h + this.box.h), a, this.getAngle())];
        }, isDynamicIntersect: function isDynamicIntersect(a) {
            if (3 > a.length) return !1;
            var b = this.getDynamicBox(),
                c;
            for (c = b.length - 1; 0 <= c; c--) {
                if (ma(b[c], a)) return !0;
            }for (c = b.length - 1; 0 <= c; c--) {
                if (ma(a[c], b)) return !0;
            }return !1;
        }, isIntersect: function isIntersect(a) {
            return a.visible ? this.angle || a.angle ? this.isDynamicIntersect(a.getDynamicBox()) : this.isStaticIntersect(a.getStaticBox()) : !1;
        }, isDynamicInside: function isDynamicInside(a) {
            if (3 > a.length) return !1;
            var b = this.getDynamicBox(),
                c,
                d = 0;
            var g = 0;
            for (c = b.length; g < c; g += 1) {
                ma(b[g], a) && (d += 1);
            }return d === b.length ? !0 : !1;
        }, drawDynamicBox: function drawDynamicBox(a) {
            P(this, 1);
            k.shadowColor = "transparent";
            za(f(this.x + this.box.x, this.y + this.box.y), E(this.w + this.box.w, this.h + this.box.h), !1, a || "yellow", 2);
            jc(f(this.x + this.w / 2 + this.center.x, this.y + this.h / 2 + this.center.y), 10, a || "yellow");
            N();
        }, drawStaticBox: function drawStaticBox(a) {
            k.shadowColor = "transparent";
            za(f(this.x + this.box.x, this.y + this.box.y), E(this.w + this.box.w, this.h + this.box.h), !1, a || "yellow", 2);
            jc(f(this.x + this.w / 2 + this.center.x, this.y + this.h / 2 + this.center.y), 10, a || "yellow");
        }, isStaticIntersect: function isStaticIntersect(a) {
        ...
        }, getStaticBoxPosition: function getStaticBoxPosition() {
            return {
                x: this.x + this.box.x,
                y: this.y + this.box.y,
        ...
        }, getStaticBox: function getStaticBox() {
        ...
        }, transparent: function transparent(a) {
        ...
        }, setCenter: function setCenter(a) {
            this.center = f(a.x, a.y);
        }, nullCenter: function nullCenter(a) {
            a || (a = f(0, 0));
            ...
            this.x += a.x;
            this.y += a.y;
        }, circling: function circling(a, b, c) {
            u(this.circlingAnglePointJS) || (this.circlingAnglePointJS = 0);
            this.x = a.x + b * Math.cos(y(this.circlingAnglePointJS));
            this.y = a.y + b * Math.sin(y(this.circlingAnglePointJS));
            this.circlingAnglePointJS = 360 < this.circlingAnglePointJS ? 0 : this.circlingAnglePointJS + c;
        }, circlingC: function circlingC(a, b, c) {
            u(this.circlingAnglePointJS) || (this.circlingAnglePointJS = 0);
            this.setPositionC(f(a.x + b * Math.cos(y(this.circlingAnglePointJS)), a.y + b * Math.sin(y(this.circlingAnglePointJS))));
            this.circlingAnglePointJS = 360 < this.circlingAnglePointJS ? 0 : this.circlingAnglePointJS + c;
        }, motion: function motion(a, b, c) {
            u(this.motionPercentPointJS) || (this.motionPercentPointJS = 0);
            this.x = a.x + b.w * Math.cos(y(this.motionPercentPointJS));
            this.y = a.y + b.h * Math.sin(y(this.motionPercentPointJS));
            this.motionPercentPointJS = 360 < this.motionPercentPointJS ? 0 : this.motionPercentPointJS + c;
        }, motionC: function motionC(a, b, c) {
            u(this.motionPercentPointJS) || (this.motionPercentPointJS = 0);
            this.setPositionC(f(a.x + b.w * Math.cos(y(this.motionPercentPointJS)), a.y + b.h * Math.sin(y(this.motionPercentPointJS))));
            this.motionPercentPointJS = 360 < this.motionPercentPointJS ? 0 : this.motionPercentPointJS + c;
        }, scale: function scale(a) {
            this.w *= a;
            this.h *= a;
        }, scaleC: function scaleC(a) {
            var b = this.w,
                c = this.h;
            this.scale(a);
            this.move(f(-((this.w - b) / 2), -((this.h - c) / 2)));
        }, getPosition: function getPosition(a) {
            return 1 === a ? f(this.x + (this.w / 2 + this.center.x), this.y + (this.h / 2 + this.center.y)) : 2 === a ? (a = f(this.x + this.w / 2, this.y + this.h / 2), this.angle && (a = H(a, this.getPosition(1), this.angle)), f(a.x, a.y)) : f(this.x, this.y);
        }, getPositionC: function getPositionC() {
            return f(this.x + (this.w / 2 + this.center.x), this.y + (this.h / 2 + this.center.y));
        }, getPositionS: function getPositionS() {
            return f(this.x + e.x, this.y + e.x);
        },
        getPositionCS: function getPositionCS() {
        ...
        }, setPositionC: function setPositionC(a) {
            this.getPosition();
            !1 !== a.x && (this.x = -(this.w / 2 + this.center.x) + a.x);
            !1 !== a.y && (this.y = -(this.h / 2 + this.center.y) + a.y);
        }, setPositionCS: function setPositionCS(a) {
            this.getPosition();
            !1 !== a.x && (this.x = -(this.w / 2 + this.center.x) + a.x + e.x);
            ...
            this.w = a.w;
            this.h = a.h;
        }, setSizeC: function setSizeC(a) {
            this.w = a.w;
            this.h = a.h;
            this.move(f(-(a.w / 2), -(a.h / 2)));
        }, turn: function turn(a) {
            this.angle += a;
        }, rotateForAngle: function rotateForAngle(a, b) {
            0 > this.angle && (this.angle += 360);
            0 > a && (a += 360);
            var c = this.angle - a;
            180 < c ? c -= 360 : -180 > c && (c += 360);
            c >= -b - .5 && c <= b + .5 ? this.angle = a : c > b + .5 ? this.angle -= b : c < -b - .5 && (this.angle += b);
        }, rotateForPoint: function rotateForPoint(a, b) {
            var c = Da(this.getPositionC(), a);
            this.rotateForAngle(c, b);
        }, rotateForObject: function rotateForObject(a, b) {
            var c = Da(this.getPositionC(), a.getPositionC());
            this.rotateForAngle(c, b);
        }, moveTo: function moveTo(a, b) {
            var c = y(Da(this.getPosition(), a));
            this.prevPosition = this.getPosition();
            this.x += b * Math.cos(c);
            this.y += b * Math.sin(c);
        }, moveToC: function moveToC(a, b) {
            var c = y(Da(this.getPositionC(), a));
            this.prevPosition = this.getPosition();
            this.x += b * Math.cos(c);
            this.y += b * Math.sin(c);
        }, moveAngle: function moveAngle(a, b) {
            b = y(u(b) ? b : this.angle);
            this.prevPosition = this.getPosition();
            this.x += a * Math.cos(b);
            this.y += a * Math.sin(b);
        }, moveTime: function moveTime(a, b) {
            b = b || 1;
            var c = this.getPosition();
            this.move(f((a.x - c.x) / b, (a.y - c.y) / b));
        }, moveTimeC: function moveTimeC(a, b) {
            b = b || 1;
        ...
        }, getDistanceC: function getDistanceC(a) {
    ...
    nb.prototype.getDynamicBox = function () {
        ...
        return 0 === this.angle ? [f(this.x + this.w / 2, this.y), f(this.x + this.w, this.y + this.h), f(this.x, this.y + this.h)] : [H(f(this.x + this.w / 2, this.y), a, this.getAngle()), H(f(this.x + this.w, this.y + this.h), a, this.getAngle()), H(f(this.x, this.y + this.h), a, this.getAngle())];
    };
    nb.prototype.draw = function () {
        ...
        if (this.visible && this.alpha) {
            ...
            Pa(this.x, this.y, [f(this.w / 2, 0), f(this.w, this.h), f(0, this.h)], this.fillColor, this.strokeWidth ? this.strokeColor : !1, this.strokeWidth);
    ...
    Fb.prototype.draw = function () {
        ...
        if (this.visible && this.alpha) {
            var a = !1;
            if (this.angle || 1 !== this.alpha || this.shadowColor) P(this), a = !0;
            za(f(this.x, this.y), E(this.w, this.h), this.fillColor, this.strokeColor, this.strokeWidth);
            if (this.ondraw) this.ondraw();
            a && N();
        }
    };
    ...
    Gb.prototype.draw = function () {
        ...
        if (this.visible && this.alpha) {
            var a = !1;
            if (this.angle || 1 !== this.alpha || this.shadowColor) P(this), a = !0;
            Hb(f(this.x, this.y), E(this.w, this.h), this.radius, this.fillColor, this.strokeColor, this.strokeWidth);
            if (this.ondraw) this.ondraw();
            a && N();
        }
    };
    ...
    qa.prototype.draw = function () {
        ...
        if (this.visible) {
            ...
            var a = !1;
            if (this.angle || 1 !== this.alpha || this.shadowColor) P(this), a = !0;
            Aa(f(this.x, this.y), this.radius, this.fillColor, this.strokeColor, this.strokeWidth);
            if (this.ondraw) this.ondraw();
            a && N();
        }
    };
    ...
    Ib.prototype.draw = function () {
        if (this.loaded) {
            ...
            for (d = 0; d < this.countY; d += 1) {
                if (!(this.y + d * this.h + this.h < e.y || this.y + d * this.h > e.y + n)) for (c = 0; c < this.countX; c += 1) {
                    this.x + c * this.w + this.w < e.x || this.x + c * this.w > e.x + m || k.drawImage(this.cnv, a + c * this.w, b + d * this.h, this.w, this.h);
                }
            }
        }
    };
    Ib.prototype.getSize = function () {
        return this.loaded ? E(this.fullW, this.fullH) : E();
    };
    ...
    aa(B, Jb);
    Jb.prototype.draw = function () {
        this.predraw();
        if (this.visible && this.alpha) {
            P(this);
            Aa(f(this.x, this.y), this.h / 2, this.fillColor, this.strokeColor, this.strokeWidth);
            if (this.ondraw) this.ondraw();
            N();
        }
    };
    ...
    var X = function X(a) {
        ...
        this.w = Kb(this.text, this.style, this.size, this.font) + 2 * this.padding;
    ...
    X.prototype.draw = function () {
        ...
        if (this.visible && this.alpha) {
            var a = !1;
            if (this.angle || 1 !== this.alpha || this.shadowColor) P(this), a = !0;
            (this.fillColor || this.strokeColor) && za(f(this.x, this.y), E(this.w, this.h), this.fillColor, this.strokeColor, this.strokeWidth);
            ra(f(this.x + this.padding, this.textDY + this.y + this.padding), this.text, this.color, this.size, this.font, this.style, this.align, this.strokeColorText, this.strokeWidthText);
            if (this.ondraw) this.ondraw();
            a && N();
        }
    };
    ...
    X.prototype.setSizeC = function (a) {
        this.size !== a && (this.reStyle({ size: a }), this.move(f(-a / 2, -a / 2)));
    };
    var Kb = function Kb(a, b, c, d) {
        var g = h.document.createElement("canvas").getContext("2d");
        g.font = b + c + "px " + d;
        return g.measureText(a).width;
    };
    this.OOP.getTextWidth = function (a) {
        return Kb(a.text, a.style || "", a.size || 10, a.font || "sans-serif");
    };
    ...
    var Q = function Q(a) {
        ...
        this.w = this.h = 0;
        var b = this;
        "undefined" !== typeof a.points && t(a.points, function (a) {
            b.addPoint(a);
        });
    };
    aa(B, Q);
    ...
    Q.prototype.isIntersect = function (a) {
        return a.visible ? this.isDynamicIntersect(a.getDynamicBox()) : !1;
    };
    Q.prototype.drawDynamicBox = function (a) {
        Pa(this.x, this.y, this.points, !1, "yellow", 1, "red");
    };
    Q.prototype.getDynamicBox = function () {
        for (var a = [], b = this.points.length - 1; 0 <= b; b--) {
            a.push(H(this.points[b], f(this.w / 2 + this.center.x, this.h / 2 + this.center.y), this.angle).plus(f(this.x, this.y)));
        }return a;
    };
    Q.prototype.draw = function () {
        ...
        if (this.visible && this.alpha) {
            var a = !1;
            if (this.angle || 1 !== this.alpha || this.shadowColor) P(this), a = !0;
            Pa(this.x, this.y, this.points, this.fillColor, this.strokeColor, this.strokeWidth, this.pointColor);
            if (this.ondraw) this.ondraw();
            a && N();
        }
    };
    ...
    sa.prototype.draw = function () {
        ...
        if (this.visible && this.alpha && this.loaded) {
            ...
            lc(f(this.x, this.y), E(this.w, this.h), this.file);
            if (this.ondraw) this.ondraw();
            a && N();
        }
    };
    sa.prototype.simpleDraw = function (a) {
        ...
        if (this.loaded) {
            ...
            lc(f(a.x, a.y), E(this.w, this.h), this.file);
            b && N();
        }
    };
    sa.prototype.setImage = function (a, b) {
        this.file !== a && (u(l[a]) ? (this.file = a, b && b()) : (this.loaded = !1, this.origHeight = this.origWidth = 0, this.forOnLoad = b || !1, kc(a, this)));
    };
    ...
    O.prototype.drawFrame = function (a) {
        if (this.visible && this.alpha) {
            var b = !1;
            if (this.angle || 1 !== this.alpha || this.flip.x || this.flip.y || this.shadowColor) P(this), b = !0;
            Lb(this.anim, f(this.x, this.y), E(this.w, this.h), a);
            if (this.ondraw) this.ondraw();
            b && N();
        }
    };
    O.prototype.drawToFrame = function (a) {
        if (this.visible && this.alpha) {
    ...
    O.prototype.drawReverFrames = function (a, b) {
        if (this.visible && this.alpha) {
            this.drawFrame(this.frame);
            if (this.ondraw) this.ondraw();
    ...
    O.prototype.setAnimation = function (a) {
        a !== this.anim && (this.frame = 0, this.anim = a);
    };
    O.prototype.getAnimation = function () {
        return this.anim;
    };
    O.prototype.setDelay = function (a) {
        this.step = 0 < a ? a : this.step;
    };
    O.prototype.getDelay = function () {
        return this.step;
    };
    O.prototype.getFrame = function () {
        return this.frame;
    };
    O.prototype.setFrame = function (a) {
        this.frame = a;
    };
    O.prototype.getLastFrame = function () {
    ...
    var cc = function cc(a) {
        var b = !1;
        "RectObject" === a.type ? b = C.game.newRectObject({}) : "CircleObject" === a.type ? b = C.game.newCircleObject({}) : "RoundRectObject" === a.type ? b = C.game.newRoundRectObject({}) : "TextObject" === a.type ? b = C.game.newTextObject({}) : "EllipsObject" === a.type ? b = C.game.newEllipsObject({}) : "ImageObject" === a.type ? b = C.game.newImageObject({ file: a.file }) : "TriangleObject" === a.type ? b = C.game.newTriangleObject({}) : "PolygonObject" === a.type ? b = C.game.newTriangleObject({ points: a.points }) : "AnimationObject" === a.type && (b = C.game.newAnimationObject({ animation: a.animation }));
        return b;
    },
        Dc = 0,
        ta = function ta(a, b) {
    ...
    ta.prototype.onContext = function (a) {
    ...
    var Ec = 0;
    ta.prototype.getAnimation = function (a, b, c, d, g) {
        var e = function e(a, b, c, d, _e, g) {
            this.id = Ec++;
            this.image = a;
            this.x = b;
            this.y = c;
            this.w = d;
            this.h = _e;
            this.endFrame = this.r = g ? g - 1 : 0;
            this.frameCount = this.r + 1;
        };
        e.prototype = {
            onContext: function onContext(a) {
    ...
    Mb.prototype.onContext = ta.prototype.onContext;
    Mb.prototype.getAnimation = ta.prototype.getAnimation;
    ...
    var Lb = function Lb(a, b, c, d) {
        if (a && a.image.loaded) {
            var g = -e.x,
                f = -e.y;
            a.image.img && k.drawImage(a.image.img, a.x + a.w * d, a.y, a.w, a.h, b.x + g, b.y + f, c.w, c.h);
        }
    },
        l = {},
        ...
        if (u(l[a])) {
            ...
            if (b.w && !b.h) {
                ...
                var g = b.w;
                var e = l[a].h * d;
            } else !b.w && b.h ? (d = b.h / l[a].h, e = b.h, g = l[a].w * d) : b.w && b.h ? (g = b.w, e = b.h) : (g = l[a].w, e = l[a].h);
            c && (g *= c, e *= c);
            b.w = g;
            b.h = e;
            b.forOnLoad && b.forOnLoad();
        } else g = h.document.createElement("img"), g.onload = function () {
            l[a] = {};
            l[a].loaded = !0;
            l[a].img = this;
            l[a].w = this.width;
            ...
            if (u(b)) {
                ...
                if (b.w && !b.h) {
                    ...
                    var e = b.w;
                    var g = l[a].h * d;
                } else !b.w && b.h ? (d = b.h / l[a].h, g = b.h, e = l[a].w * d) : b.w && b.h ? (e = b.w, g = b.h) : (e = l[a].w, g = l[a].h);
                c && (e *= c, g *= c);
                b.w = e;
                b.h = g;
                b.file = a;
        ...
        if (c) {
            var d = -e.x,
                g = -e.y;
            l[c] && k.drawImage(l[c].img, 0, 0, l[c].w, l[c].h, a.x + d, a.y + g, b.w, b.h);
        }
    },
        mc = function mc(a) {
        this.type = "Mesh";
        ...
        move: function move(a) {
            ...
            if (0 != a) {
                ...
                t(this.objs, function (d) {
                    d.turn(a);
                    d.setPositionC(H(f(c.x + d.offsetMesh.x, c.y + d.offsetMesh.y), b, c.angle));
                });
            }
        }, setAngle: function setAngle(a) {
            if (a != this.angle) {
            ...
            if (this.x != a.x || this.y != a.y) {
                ...
                var b = this;
                t(this.objs, function (a) {
                    b.angle ? a.setPositionC(H(f(b.x + a.offsetMesh.x, b.y + a.offsetMesh.y), f(b.x, b.y), b.angle)) : a.setPositionC(f(b.x + a.offsetMesh.x, b.y + a.offsetMesh.y));
                });
            }
        }, isDynamicIntersect: function isDynamicIntersect(a) {
            if (3 > a.length) return !1;
    ...
    this.camera.circling = function (a, b, c) {
        ...
        e.x = a.x + b * Math.cos(y(this.circlingAnglePointJS));
        e.y = a.y + b * Math.sin(y(this.circlingAnglePointJS));
    ...
    this.camera.circlingC = function (a, b, c) {
        u(this.circlingAnglePointJS) || (this.circlingAnglePointJS = c);
        e.x = -F + a.x + b * Math.cos(y(this.circlingAnglePointJS));
        e.y = -G + a.y + b * Math.sin(y(this.circlingAnglePointJS));
        this.circlingAnglePointJS = 360 <= this.circlingAnglePointJS ? c : this.circlingAnglePointJS + c;
    };
    this.camera.motion = function (a, b, c) {
        u(this.motionPercentPointJS) || (this.motionPercentPointJS = b);
        e.x = a.x + b.w * Math.cos(y(this.motionPercentPointJS));
        e.y = a.y + b.h * Math.sin(y(this.motionPercentPointJS));
    ...
    this.camera.moveTime = function (a, b) {
        b = b || 1;
        var c = f(e.x, e.y);
        this.move(f(ka * (a.x - c.x) / b, la * (a.y - c.y) / b));
    };
    ...
    this.camera.setPosition = function (a) {
        Db(f(!1 !== a.x ? a.x : e.x, !1 !== a.y ? a.y : e.y));
    };
    this.camera.setPositionC = function (a) {
        Db(f(!1 !== a.x ? a.x - F : e.x, !1 !== a.y ? a.y - G : e.y));
    };
    this.camera.getPosition = function (a) {
        return a ? f(e.x + F, e.y + G) : f(e.x, e.y);
    };
    this.camera.getPositionC = function () {
        return f(e.x + F, e.y + G);
    };
    this.camera.getStaticBox = function () {
        return { x: e.x, y: e.y, w: e.x + m, h: e.y + n };
    };
    ...
    var Db = function Db(a) {
        ...
        a.angle && (k.translate(-e.x + c.x, -e.y + c.y), k.rotate(y(a.angle)), k.translate(-c.x + e.x, -c.y + e.y));
        1 != a.alpha && (k.globalAlpha = a.alpha);
        if (a.flip.x || a.flip.y) k.translate(-e.x + c.x, -e.y + c.y), k.scale(a.flip.x ? -1 : 1, a.flip.y ? -1 : 1), k.translate(-c.x + e.x, -c.y + e.y);
    ...
    var Pa = function Pa(a, b, c, d, g, h, l) {
        if (!(3 > c.length)) {
            if (d && !(3 > c.length)) {
                k.fillStyle = d;
                d = -e.x + a;
                ...
                for (A = 1; A < c.length; A += 1) {
                    k.lineTo(d + c[A].x, m + c[A].y);
                }k.closePath();
                k.fill();
            }
            for (d = 0; d < c.length; d += 1) {
                m = d + 1 < c.length ? d + 1 : 0, g && Y(Ra(c[d], f(a, b)), Ra(c[m], f(a, b)), g, h), l && ob(Ra(c[d], f(a, b)), l);
            }
        }
    },
        R = function R(a) {
    ...
    this.brush.drawPolygon = function (a) {
        ...
        if (!(3 > b.length)) {
            if (c && !(3 > b.length)) {
                ...
                var h;
                k.beginPath();
                k.moveTo(c + b[0].x, f + b[0].y);
                for (h = 1; h < b.length; h += 1) {
                    k.lineTo(c + b[h].x, f + b[h].y);
                }k.closePath();
                k.fill();
            }
            for (c = 0; c < b.length; c += 1) {
                f = c + 1 < b.length ? c + 1 : 0, d && Y(b[c], b[f], d, g), a && ob(b[c], a);
            }
        }
    };
    this.brush.drawTriangle = function (a) {
        ...
        Pa(a.x, a.y, [f(a.w / 2, 0), f(a.w, a.h), f(0, a.h)], a.fillColor, a.strokeColor, a.strokeWidth);
    };
    this.brush.drawTriangleS = function (a) {
        R(a);
        if (0 > a.x + a.w || a.x > m || 0 > a.y + a.h || a.y > n) return !1;
        Pa(e.x + a.x, e.y + a.y, [f(a.w / 2, 0), f(a.w, a.h), f(0, a.h)], a.fillColor, a.strokeColor, a.strokeWidth);
    };
    var ra = function ra(a, b, c, d, g, f, h, l, m) {
        k.textAlign = h;
        k.lineWidth = m;
        k.font = (f ? f + " " : "") + d + "px " + g;
        d = -e.x;
        g = -e.y;
        c && (k.fillStyle = c, k.fillText(b, d + a.x, g + a.y));
        l && (k.strokeStyle = l, k.strokeText(b, d + a.x, g + a.y));
    };
    this.brush.drawMultiText = function (a) {
        var b,
            c = a.text.split("\n");
        for (b = 0; b < c.length; b += 1) {
            ra(f(a.x, a.y + a.size * b), c[b], a.color || r.fillStyle, a.size || 10, a.font || r.font, a.style || !1, a.align || "left", a.strokeColor || !1, a.strokeWidth || 2);
        }
    };
    this.brush.drawMultiTextS = function (a) {
        var b,
            ...
            d = a.size || 10;
        for (b = 0; b < c.length; b += 1) {
            ra(f(a.x + e.x, a.y + e.y + d * b), c[b], a.color || r.fillStyle, d || 10, a.font || r.font, a.style || !1, a.align || "left", a.strokeColor || !1, a.strokeWidth || 2);
        }
    };
    this.brush.drawText = function (a) {
        ra(f(a.x || 0, a.y || 0), a.text, a.color || !1, a.size || 10, a.font || r.font, a.style || !1, a.align || "left", a.strokeColor || !1, a.strokeWidth || 2);
    };
    this.brush.drawTextS = function (a) {
        ra(f((a.x || 0) + e.x, (a.y || 0) + e.y), a.text, a.color || r.fillStyle, a.size || 10, a.font || r.font, a.style || !1, a.align || "left", a.strokeColor || !1, a.strokeWidth || 2);
    };
    this.brush.drawTextLines = function (a) {
        if (a.lines) {
            ...
            for (b = 0; b < a.lines.length; b += 1) {
                ra(f(a.x || 0, (a.y || 0) + c * b), a.lines[b], a.color || r.fillStyle, c, a.font || r.font, a.style || !1, a.align || "left", a.strokeColor || !1, a.strokeWidth || 2);
            }
        }
    };
    this.brush.drawTextLinesS = function (a) {
        if (a.lines) {
            var b,
                c = a.size || 10;
            for (b = 0; b < a.lines.length; b += 1) {
                ra(f((a.x || 0) + e.x, (a.y || 0) + e.y + c * b), a.lines[b], a.color || r.fillStyle, c, a.font || r.font, a.style || !1, a.align || "left", a.strokeColor || !1, a.strokeWidth || 2);
            }
        }
    };
    var jc = function jc(a, b, c) {
        Y(f(a.x - b, a.y), f(a.x + b, a.y), c, 2);
        Y(f(a.x, a.y - b), f(a.x, a.y + b), c, 2);
    },
        za = function za(a, b, c, d, g) {
        k.fillStyle = c;
        k.strokeStyle = d;
        k.lineWidth = g;
        d = -e.x + (g ? g / 2 : 0);
        var f = -e.y + (g ? g / 2 : 0);
        c && k.fillRect(a.x + d, a.y + f, b.w, b.h);
        g && k.strokeRect(a.x + d, a.y + f, b.w, b.h);
    };
    this.brush.drawRect = function (a) {
        R(a);
        if (a.x + a.w < e.x || a.x > e.x + m || a.y + a.h < e.y || a.y > e.y + n) return !1;
        za(f(a.x, a.y), E(a.w, a.h), a.fillColor || !1, a.strokeColor || r.strokeStyle, a.strokeWidth || !1);
    };
    this.brush.drawRectS = function (a) {
        R(a);
        if (0 > a.x + a.w || a.x > m || 0 > a.y + a.h || a.y > n) return !1;
        za(f(a.x + e.x, a.y + e.y), E(a.w, a.h), a.fillColor || !1, a.strokeColor || r.strokeStyle, a.strokeWidth || !1);
    };
    var ob = function ob(a, b) {
        (k.fillStyle = b) && k.fillRect(-e.x + a.x - 1, -e.y + a.y - 1, 2, 2);
    };
    this.brush.drawPoint = function (a) {
        R(a);
        if (a.x < e.x || a.x > e.x + m || a.y < e.y || a.y > e.y + n) return !1;
        ob(f(a.x, a.y), a.fillColor || !1);
    };
    this.brush.drawPointS = function (a) {
        R(a);
        if (0 > a.x || a.x > m || 0 > a.y || a.y > n) return !1;
        ob(f(a.x + e.x, a.y + e.y), a.fillColor || !1);
    };
    var Hb = function Hb(a, b, c, d, g, f) {
        k.fillStyle = d;
        k.strokeStyle = g;
        k.lineWidth = f;
        g = -e.x + a.x + (f ? f / 2 : 0);
        ...
        k.moveTo(g + c, a);
        k.lineTo(g + b.w - c, a);
        k.quadraticCurveTo(g + b.w, a, g + b.w, a + c);
        k.lineTo(g + b.w, a + b.h - c);
        k.quadraticCurveTo(g + b.w, a + b.h, g + b.w - c, a + b.h);
        k.lineTo(g + c, a + b.h);
        k.quadraticCurveTo(g, a + b.h, g, a + b.h - c);
        k.lineTo(g, a + c);
        k.quadraticCurveTo(g, a, g + c, a);
        k.closePath();
        d && k.fill();
        f && k.stroke();
    };
    this.brush.drawRoundRect = function (a) {
        R(a);
        if (a.x + a.w < e.x || a.x > e.x + m || a.y + a.h < e.y || a.y > e.y + n) return !1;
        Hb(f(a.x, a.y), E(a.w, a.h), a.radius || 2, a.fillColor || !1, a.strokeColor || r.strokeStyle, a.strokeWidth || !1);
    };
    this.brush.drawRoundRectS = function (a) {
        R(a);
        if (0 > a.x + a.w || a.x > m || 0 > a.y + a.h || a.y > n) return !1;
        Hb(f(e.x + a.x, e.y + a.y), E(a.w, a.h), a.radius || 2, a.fillColor || !1, a.strokeColor || r.strokeStyle, a.strokeWidth || !1);
    };
    var Aa = function Aa(a, b, c, d, g) {
        k.fillStyle = c;
        k.strokeStyle = d;
        k.lineWidth = g;
        d = -e.x + b + (g ? g / 2 : 0);
        var f = -e.y + b + (g ? g / 2 : 0);
        k.beginPath();
        k.arc(a.x + d, a.y + f, b, 0, 2 * Math.PI, !0);
        k.closePath();
        c && k.fill();
        g && k.stroke();
    };
    this.brush.drawCircle = function (a) {
        ...
        Aa(f(a.x, a.y), a.radius, a.fillColor || !1, a.strokeColor || r.strokeStyle, a.strokeWidth || !1);
    };
    this.brush.drawCircleS = function (a) {
        R(a);
        var b = 2 * a.radius;
        if (0 > a.x + b || a.x > m || 0 > a.y + b || a.y > n) return !1;
        Aa(f(a.x + e.x, a.y + e.y), a.radius, a.fillColor || !1, a.strokeColor || r.strokeStyle, a.strokeWidth || !1);
    };
    var Y = function Y(a, b, c, d) {
        k.strokeStyle = c;
        k.lineWidth = d;
        c = -e.x;
        d = -e.y;
    ...
    this.brush.drawLineAngle = function (a) {
        var b = H(f(a.x + a.length, a.y), f(a.x, a.y), a.angle);
        Y(f(a.x, a.y), f(b.x, b.y), a.strokeColor || r.strokeStyle, a.strokeWidth || 1);
    };
    this.brush.drawLineAngleS = function (a) {
        var b = H(f(e.x + a.x + a.length, e.y + a.y), f(e.x + a.x, e.y + a.y), a.angle);
        Y(f(e.x + a.x, e.y + a.y), f(b.x, b.y), a.strokeColor || r.strokeStyle, a.strokeWidth || 1);
    };
    this.brush.drawLine = function (a) {
        Y(f(a.x1, a.y1), f(a.x1 + a.x2, a.y1 + a.y2), a.strokeColor || r.strokeStyle, a.strokeWidth || 1);
    };
    this.brush.drawLineS = function (a) {
        Y(f(e.x + a.x1, e.y + a.y1), f(e.x + a.x2, e.y + a.y2), a.strokeColor || r.strokeStyle, a.strokeWidth || 1);
    };
    this.brush.drawLineA = function (a) {
        Y(f(a.x1, a.y1), f(a.x2, a.y2), a.strokeColor || r.strokeStyle, a.strokeWidth || 1);
    };
    this.brush.drawLineAS = function (a) {
        Y(f(a.x1 + e.x, a.y1 + e.y), f(a.x2 + e.x, a.y2 + e.y), a.strokeColor || r.strokeStyle, a.strokeWidth || 1);
    };
    this.brush.drawEllips = function (a) {
        ...
        k.scale(b / c, 1);
        k.translate(-d.x, -d.y);
        Aa(f(a.x, a.y), c, a.fillColor, a.strokeColor, a.strokeWidth);
        k.restore();
    };
    this.brush.drawEllipsS = function (a) {
        ...
        k.scale(b / c, 1);
        k.translate(-d.x, -d.y);
        Aa(f(e.x + a.x, e.y + a.y), c, a.fillColor, a.strokeColor, a.strokeWidth);
        k.restore();
    };
    this.brush.drawImageS = function (a) {
        if (a.file) if (u(l[a.file])) {
            if (l[a.file].loaded) {
                ...
                k.drawImage(l[a.file].img, 0, 0, l[a.file].w, l[a.file].h, b, c, e, f);
            }
    ...
    this.brush.drawImage = function (a) {
        if (a.file) if (u(l[a.file])) {
            if (l[a.file].loaded) {
                ...
                a.scale && (f *= a.scale, p *= a.scale);
                if (b + f < e.x || b > e.x + m || c + p < e.y || c > e.y + n) return !1;
                k.drawImage(l[a.file].img, 0, 0, l[a.file].w, l[a.file].h, -e.x + b, -e.y + c, f, p);
            }
    ...
    this.brush.onPixel = function (a, b, c) {
        var d = k.getImageData(a, b, 1, 1),
            e = {
            r: d.data[0], g: d.data[1], b: d.data[2], a: d.data[3] ? d.data[3] : 255
        };
        c(e);
        d.data[0] = e.r;
        d.data[1] = e.g;
    ...
    var S = h.AudioContext || h.webkitAudioContext || !1;
    (S = S ? new S() : !1) && S.listener.setPosition(0, 0, 0);
    var T = function T(a, b) {
        S || Z('module "wAudio" is not supported! use a "audio"');
        ...
        d.onload = function (a) {
            S.decodeAudioData(this.response, function (a) {
                ...
                Z("error in wAudio.newAudio : error decoding file", a);
            });
        };
        a ? d.send() : Z("error in wAudio.newAudio : Where is file?");
        x.add();
    };
    ...
    var ca = function ca(a, b) {
        var c,
            d = h.document.createElement("audio");
        if ("string" == typeof a) {
            ...
            for (c = a.length; f < c; f += 1) {
                e = h.document.createElement("source"), e.src = a[f], d.appendChild(e);
            }
        }
        this.vol = b && 1 >= b && 0 < b ? b : 1;
        this.playing = 0;
    ...
    this.zList.del = function (a) {
        C.OOP.delObject(pb, a);
    };
    this.zList.useYValue();
    var x = {
        count: 0, loaded: 0, errored: 0, add: function add() {
            this.count += 1;
        }, load: function load() {
            this.loaded += 1;
    ...
    this.resources.isLoaded = function () {
        return x.count == x.loaded;
    };
    this.resources.getProgress = function () {
        return Math.ceil(x.loaded / x.count * 100);
    };
    ...
    var Fc = function Fc(a) {
        ...
        this.draw = function (a) {
            this.backgroundColor && C.game.fill(this.backgroundColor);
            t(d, function (b) {
                a && a(b);
                b.isInCamera() && b.draw();
            });
    ...
    this.system.initFPSCheck = function () {
        rc || (rc = !0, p.addEvent("postLoop", "fpsCheckUpdate", function () {
            Nb += 1;
            1E3 <= L - qc && (pc = Nb, Nb = 0, qc = L);
        }));
    };
    ...
    this.OOP.newTimer = function (a, b) {
        ...
        var c = {
            time: 0 < a ? a : 1E3, func: b, startTime: !1, ending: !1, start: function start() {
        ...
        p.addEvent("postLoop", "timer" + ba(-100, 100) * ba(-100, 100) + L, function () {
            c.run();
        });
        return c;
    };
    this.memory.local = {
        storage: h.localStorage, clear: function clear() {
            this.storage.clear();
        }, save: function save(a, b) {
            this.storage.setItem(a, b);
        }, saveAsObject: function saveAsObject(a, b) {
            var c = JSON.stringify(b);
            this.storage.setItem(a, c);
        }, loadAsObject: function loadAsObject(a) {
            return JSON.parse(this.storage.getItem(a) || "false");
        }, load: function load(a) {
            return this.storage.getItem(a);
        }, loadAsNumber: function loadAsNumber(a) {
            return parseFloat(this.storage.getItem(a));
        }
    };
    this.memory.temp = {
        values: {}, save: function save(a, b) {
            this.values[a] = b;
        }, load: function load(a) {
    ...
    h.onblur = function () {
        if (fa) return p.runEvent("gameBlur"), !1;
    };
    h.onfocus = function () {
        if (!fa) return h.document.activeElement.blur(), h.focus(), p.runEvent("gameFocus"), !1;
    };
    h.onresize = function () {
        p.runEvent("gameResize");
        k && (k.textBaseline = r.textBaseline, m /= ka, n /= la, F = m / 2, G = n / 2, k.scale(ka, la));
        return !1;
    };
    h.onclick = function () {
...
/* styles */
__webpack_require__(/*! !vue-style-loader!css-loader!../../node_modules/vue-loader/lib/style-rewriter?id=data-v-80fb1d46!sass-loader?indentedSyntax!../../node_modules/vue-loader/lib/selector?type=styles&index=0!./stats.vue */ 337)

var Component = __webpack_require__(/*! ../../node_modules/vue-loader/lib/component-normalizer */ 21)(
  /* script */
  __webpack_require__(/*! !babel-loader!../../node_modules/vue-loader/lib/selector?type=script&index=0!./stats.vue */ 340),
  /* template */
  __webpack_require__(/*! !../../node_modules/vue-loader/lib/template-compiler?id=data-v-80fb1d46!../../node_modules/vue-loader/lib/selector?type=template&index=0!./stats.vue */ 373),
  /* scopeId */
  null,
  /* cssModules */
  null
)
Component.options.__file = "C:\\dev\\PointDebugger\\src\\components\\stats.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-80fb1d46", Component.options)
  } else {
    hotAPI.reload("data-v-80fb1d46", Component.options)
  }
})()}
...
/* 337 */
/*!*************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-style-loader!./node_modules/css-loader!./node_modules/vue-loader/lib/style-rewriter.js?id=data-v-80fb1d46!./node_modules/sass-loader/lib/loader.js?indentedSyntax!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./src/components/stats.vue ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
// load the styles
var content = __webpack_require__(/*! !../../node_modules/css-loader!../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-80fb1d46!../../node_modules/sass-loader/lib/loader.js?indentedSyntax!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./stats.vue */ 338);
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(/*! ../../node_modules/vue-style-loader/lib/addStylesClient.js */ 126)("5595efaf", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-80fb1d46!../../node_modules/sass-loader/lib/loader.js?indentedSyntax!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./stats.vue", function() {
     var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-80fb1d46!../../node_modules/sass-loader/lib/loader.js?indentedSyntax!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./stats.vue");
...
/* 338 */
/*!*****************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader!./node_modules/vue-loader/lib/style-rewriter.js?id=data-v-80fb1d46!./node_modules/sass-loader/lib/loader.js?indentedSyntax!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./src/components/stats.vue ***!
  \*****************************************************************************************************************************************************************************************************************************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {

exports = module.exports = __webpack_require__(/*! ../../node_modules/css-loader/lib/css-base.js */ 125)(false);
// imports
...
/* 340 */
/*!********************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/components/stats.vue ***!
  \********************************************************************************************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = ({
    props: ['pjs'],
    components: {
        appMenu: __webpack_require__(/*! ./menu.vue */ 341)
    },
    mounted() {
        ...
        (function update() {
            ...
            // Очищаем весь холст
            context.clearRect(0, 0, statsSize[mode][0], statsSize[mode][1]);
            ...
            drawText({
                x: 2,
                y: mode === 0 ? statsHeight + 19 : 12,
                size: 11,
                text: `FPS: ${fps.current}` + (mode < 2 ? ` (${fps.min}-${maxFps})` : ''),
                color: fps.color
            });

            drawText({
                x: 2,
                y: mode === 0 ? statsHeight + 37 : 27,
                size: 11,
                text: `SPEED: ${speed.current.toFixed(2)}` + (mode < 2 ? ` (${speed.min.toFixed(2)}-${speed.max.toFixed(2)})` : ''),
                color: speed.color
            });
        ...
        const updateConf = function () {
            ...
            const isArray = Array.isArray(self.object);

            const params = ['x', 'y', 'w', 'h', 'fillColor', 'radius', 'angle', 'color', 'strokeColor', 'strokeWidth', 'alpha', 'visible', 'size', 'text', 'file'];

            self.pjs.OOP.forEach(params, e => {
                self.$refs.menu.$refs[e].update(isArray ? null : self.object[e]);
            });

            self.$refs.menu.$refs.flipX.update(isArray ? null : self.object.flip.x);
            self.$refs.menu.$refs.flipY.update(isArray ? null : self.object.flip.y);
            self.$refs.menu.$refs.ondraw.update(isArray ? 'function(){}' : self.object.ondraw || 'function(){}');
        };
        ...
        const game = this.pjs.game;
        const OOP = this.pjs.OOP;

        const objects = ['Rect', 'Circle', 'RoundRect', 'Animation', 'Image', 'Text'];

        OOP.forEach(objects, type => {
            game['new' + type + 'Object'] = function (e) {
                return function () {
                    const object = e.apply(this, arguments);
                    self.objects.push({
                        object,
                        cfg: {
                            name: type + ' #' + object.id,
                    ...
                    if (object.file && self.files.findIndex(e => e === object.file) === -1) {
                        self.files.push(object.file);
                    }

                    return object;
                };
            }(game['new' + type + 'Object']);
        });
        ...
        game.newLoopFromConstructor = function (e) {
            return function () {
                game.newLoopFromClassObject(arguments[0], new arguments[1]());
            };
        }(game.newLoopFromConstructor);
    },
    methods: {
        updateObject(e) {
            this.object = e;
        ...
        hover(e) {
            ...
            if (e) {
                ...
                this.pjs.OOP.forArr(this.objects, e => {
                    const object = e.object;

                    if (!object._alpha && object._alpha !== 0) {
        ...
        setMode() {
            ...
            canvas.width = statsSize[mode][0];
            canvas.height = statsSize[mode][1];

            this.style = {
                width: statsSize[mode][0] + 'px',
                height: statsSize[mode][1] + 'px'
            };
        }
    },
    data() {
...
/* styles */
__webpack_require__(/*! !vue-style-loader!css-loader!../../node_modules/vue-loader/lib/style-rewriter?id=data-v-c86c5bde!sass-loader?indentedSyntax!../../node_modules/vue-loader/lib/selector?type=styles&index=0!./menu.vue */ 342)

var Component = __webpack_require__(/*! ../../node_modules/vue-loader/lib/component-normalizer */ 21)(
  /* script */
  __webpack_require__(/*! !babel-loader!../../node_modules/vue-loader/lib/selector?type=script&index=0!./menu.vue */ 344),
  /* template */
  __webpack_require__(/*! !../../node_modules/vue-loader/lib/template-compiler?id=data-v-c86c5bde!../../node_modules/vue-loader/lib/selector?type=template&index=0!./menu.vue */ 372),
  /* scopeId */
  null,
  /* cssModules */
  null
)
Component.options.__file = "C:\\dev\\PointDebugger\\src\\components\\menu.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-c86c5bde", Component.options)
  } else {
    hotAPI.reload("data-v-c86c5bde", Component.options)
  }
})()}
...
/* 342 */
/*!************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-style-loader!./node_modules/css-loader!./node_modules/vue-loader/lib/style-rewriter.js?id=data-v-c86c5bde!./node_modules/sass-loader/lib/loader.js?indentedSyntax!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./src/components/menu.vue ***!
  \************************************************************************************************************************************************************************************************************************************************************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
// load the styles
var content = __webpack_require__(/*! !../../node_modules/css-loader!../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-c86c5bde!../../node_modules/sass-loader/lib/loader.js?indentedSyntax!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./menu.vue */ 343);
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(/*! ../../node_modules/vue-style-loader/lib/addStylesClient.js */ 126)("e6b2bbe4", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-c86c5bde!../../node_modules/sass-loader/lib/loader.js?indentedSyntax!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./menu.vue", function() {
     var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-c86c5bde!../../node_modules/sass-loader/lib/loader.js?indentedSyntax!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./menu.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* 343 */
/*!****************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader!./node_modules/vue-loader/lib/style-rewriter.js?id=data-v-c86c5bde!./node_modules/sass-loader/lib/loader.js?indentedSyntax!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./src/components/menu.vue ***!
  \****************************************************************************************************************************************************************************************************************************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, "\n#app .pd {\n  z-index: 999999999;\n  box-shadow: 3px 0 22px 0 rgba(255, 255, 255, 0.4);\n  display: flex;\n  top: 0;\n  width: 400px;\n  background: #373737;\n  position: absolute;\n  transition: right 310ms ease-in-out;\n  height: 100%;\n}\n#app .pd .pd_conf {\n    overflow-y: scroll;\n    max-height: 100%;\n}\n#app .pd .pd_return {\n    background: linear-gradient(to bottom, #272727, #1f1f1f);\n    padding: 10px;\n    color: gray;\n    width: 400px;\n    cursor: pointer;\n}\n#app .pd .pd_button {\n    background: #1c1c1c;\n    color: white;\n    width: 25px;\n}\n#app .pd .pd_button .pdTitle {\n      transform: rotate(-90deg);\n      margin-top: 50vh;\n}\n#app .pd .pd_section {\n    position: relative;\n}\n#app .pd .pd_section .pd_title {\n      position: relative;\n      width: 400px;\n      background: black;\n      cursor: pointer;\n      padding: 5px 5px 5px 19px;\n      color: gray;\n      border-bottom: 1px solid #2c2c2c;\n}\n#app .pd .pd_section .pd_title:hover {\n        color: white;\n}\n#app .pd .pd_section .pd_content {\n      display: block;\n      flex-direction: column;\n      position: relative;\n      transition: height 310ms ease-in-out;\n      margin-left: 5px;\n      overflow-y: scroll;\n      max-height: calc(100vh - 103px);\n}\n#app .pd .pd_wrap {\n    background: #2f2f2f;\n    display: flex;\n    width: auto;\n    border: none;\n    border-bottom: 1px solid #202020;\n}\n#app .pd .pd_wrap:hover {\n      background: #111111;\n}\n#app .pd .pd_wrap.pd_select {\n      border-left: 5px solid #5cd6ae;\n}\n#app .pd .pd_wrap.pd_slider {\n      border-left: 5px solid #2FA1D6;\n}\n#app .pd .pd_wrap.pd_text {\n      border-left: 5px solid #1ED36F;\n}\n#app .pd .pd_wrap.pd_text input {\n        margin: 3px;\n}\n#app .pd .pd_wrap.pd_button {\n      border-left: 5px solid #E61D5F;\n}\n#app .pd .pd_wrap.pd_checkbox {\n      position: relative;\n      cursor: pointer;\n      border-left: 5px solid #806787;\n}\n#app .pd .pd_wrap.pd_checkbox .pd_isShowFilter {\n        display: inline-block;\n        position: absolute;\n        right: 49px;\n        top: 0;\n        color: #609aff;\n        background: #4a4949;\n        padding: 9px;\n}\n#app .pd .pd_wrap.pd_checkbox .pd_isShowFilter.disabled {\n          opacity: .5;\n}\n#app .pd .pd_wrap.pd_checkbox .pd_isShowFilter.disabled:hover {\n            background: #4a4949;\n}\n#app .pd .pd_wrap.pd_checkbox .pd_isShowFilter:hover {\n          background: #3e3d3d;\n}\n#app .pd .pd_wrap .pd_name {\n      font-size: small;\n      width: 150px;\n      color: #CBCBCB;\n      display: flex;\n      align-items: center;\n      justify-content: left;\n      margin-left: 10px;\n}\n#app .pd .pd_wrap .pd_checkbox {\n      position: relative;\n      display: flex;\n      align-items: center;\n      justify-content: left;\n      background: #4a4a4a;\n      font-size: small;\n      color: #2FA1D6;\n      margin: 5px;\n}\n#app .pd .pd_wrap .pd_checkbox .pd_y, #app .pd .pd_wrap .pd_checkbox .pd_n {\n        padding: 5px;\n}\n#app .pd .pd_wrap .pd_option {\n      z-index: 3;\n      display: flex;\n      align-items: center;\n      justify-content: left;\n      color: #2FA1D6;\n      background: #4a4a4a;\n      margin: 5px;\n      cursor: pointer;\n      font-size: small;\n      padding: 5px;\n      width: 185px;\n}\n#app .pd .pd_wrap .pd_option:hover {\n        background: #3C3C3C;\n}\n#app .pd .pd_wrap .pd_options {\n      position: relative;\n      left: 195px;\n      top: 30px;\n      display: flex;\n      flex-direction: column;\n      width: 185px;\n}\n#app .pd .pd_wrap .pd_options .pd_option {\n        width: 100%;\n        margin: 0;\n}\n#app .pd .pd_wrap .pd_slider {\n      display: flex;\n      align-items: center;\n      justify-content: left;\n      width: 150px;\n      position: relative;\n      background: #4a4a4a;\n      margin: 5px;\n}\n#app .pd .pd_wrap .pd_slider:hover {\n        background: #3C3C3C;\n}\n#app .pd .pd_wrap .pd_slider input[type=\"range\"] {\n        position: absolute;\n        display: inline-block;\n        width: 100%;\n        top: 0;\n        left: 0;\n        opacity: 0;\n        cursor: ew-resize;\n        height: 20px;\n}\n#app .pd .pd_wrap .pd_slider .pd_width {\n        height: 20px;\n        background: #44ABDA;\n}\n#app .pd .pd_wrap .pd_text {\n      margin-right: 5px;\n      font-size: small;\n      color: #44ABDA;\n      font-weight: bold;\n      display: flex;\n      align-items: center;\n      justify-content: left;\n}\n#app .pd .pd_wrap .pd_numeric {\n      display: flex;\n      align-items: center;\n      justify-content: left;\n}\n#app .pd .pd_wrap .pd_numeric input {\n        width: 40px;\n        height: 14px;\n}\n#app .pd .pd_wrap {\n    background: #2f2f2f;\n    display: flex;\n    width: auto;\n    border: none;\n    border-bottom: 1px solid #202020;\n}\n#app .pd .pd_wrap:hover {\n      background: #111111;\n}\n#app .pd .pd_wrap.pd_select {\n      border-left: 5px solid #5cd6ae;\n}\n#app .pd .pd_wrap.pd_slider {\n      border-left: 5px solid #2FA1D6;\n}\n#app .pd .pd_wrap.pd_text {\n      border-left: 5px solid #1ED36F;\n}\n#app .pd .pd_wrap.pd_text input {\n        margin: 3px;\n}\n#app .pd .pd_wrap.pd_button {\n      border-left: 5px solid #E61D5F;\n}\n#app .pd .pd_wrap.pd_button .pd_name {\n        padding: 5px;\n        width: 100%;\n}\n#app .pd .pd_wrap.pd_filter {\n      border-left: 5px solid #d2e692;\n}\n#app .pd .pd_wrap.pd_filter .pd_name {\n        padding: 5px;\n        width: 50px;\n}\n#app .pd .pd_wrap.pd_filter .pd_select {\n        display: inline-block;\n        border: 1px solid black;\n        border-radius: 3px;\n        display: flex;\n        align-items: center;\n        justify-content: left;\n        margin: 5px;\n}\n#app .pd .pd_wrap.pd_filter .pd_select div {\n          display: flex;\n          align-items: center;\n          justify-content: left;\n          padding: 3px;\n          border-right: 1px solid black;\n          cursor: pointer;\n}\n#app .pd .pd_wrap.pd_filter .pd_select div.active {\n            color: white;\n}\n#app .pd .pd_wrap.pd_filter .pd_select div:hover {\n            color: gray;\n}\n#app .pd .pd_wrap.pd_filter .pd_select div:last-child {\n            border-right: none;\n}\n#app .pd .pd_wrap.pd_filter input {\n        margin: 7px;\n        margin-left: 10px;\n}\n#app .pd .pd_wrap.pd_checkbox {\n      border-left: 5px solid #806787;\n}\n#app .pd .pd_wrap .pd_name {\n      font-size: small;\n      width: 150px;\n      color: #CBCBCB;\n      display: flex;\n      align-items: center;\n      justify-content: left;\n      margin-left: 10px;\n}\n#app .pd .pd_wrap .pd_option {\n      z-index: 3;\n      display: flex;\n      align-items: center;\n      justify-content: left;\n      color: #2FA1D6;\n      background: #4a4a4a;\n      margin: 5px;\n      cursor: pointer;\n      font-size: small;\n      padding: 5px;\n      width: 185px;\n}\n#app .pd .pd_wrap .pd_option:hover {\n        background: #3C3C3C;\n}\n#app .pd .pd_wrap .pd_options {\n      position: absolute;\n      left: 195px;\n      top: 30px;\n      display: flex;\n      flex-direction: column;\n      width: 185px;\n}\n#app .pd .pd_wrap .pd_options .pd_option {\n        width: 100%;\n        margin: 0;\n}\n#app .pd .pd_wrap .pd_slider {\n      display: flex;\n      align-items: center;\n      justify-content: left;\n      width: 150px;\n      position: relative;\n      background: #4a4a4a;\n      margin: 5px;\n}\n#app .pd .pd_wrap .pd_slider:hover {\n        background: #3C3C3C;\n}\n#app .pd .pd_wrap .pd_slider input[type=\"range\"] {\n        position: absolute;\n        display: inline-block;\n        width: 100%;\n        top: 0;\n        left: 0;\n        opacity: 0;\n        cursor: ew-resize;\n        height: 20px;\n}\n#app .pd .pd_wrap .pd_slider .pd_width {\n        height: 20px;\n        background: #44ABDA;\n}\n#app .pd .pd_wrap .pd_text {\n      margin-right: 5px;\n      font-size: small;\n      color: #44ABDA;\n      font-weight: bold;\n      display: flex;\n      align-items: center;\n      justify-content: left;\n}\n#app .pd .pd_wrap .pd_numeric {\n      display: flex;\n      align-items: center;\n      justify-content: left;\n}\n#app .pd .pd_wrap .pd_numeric input {\n        width: 40px;\n        height: 14px;\n}\n", ""]);
...
const clearEvents = function (e) {
    ...
    e.addEventListener("mousepress", d, !1);
    e.addEventListener("mouseup", d, !1);
    e.addEventListener("mousemove", d, !1);
    e.addEventListener("keypress", d, !1);
    e.addEventListener("keydown", d, !1);
    e.addEventListener("keyup", d, !1);
    e.addEventListener("click", d, !1);
    e.addEventListener("wheel", d, !1);
    e.addEventListener("mousewheel", d, !1);
    e.addEventListener("contextmenu", d, !1);
    e.addEventListener("selectstart", d, !1);
    e.addEventListener("dragstart", d, !1);
    e.addEventListener("DOMMouseScroll", d, !1);
};

/* harmony default export */ __webpack_exports__["default"] = ({
    props: ['hide', 'pjs', 'objects', 'object', 'close', 'files', 'hover', 'updateObject'],
    created() {
        const params = ['x', 'y', 'w', 'h', 'text', 'size', 'fillColor', 'color', 'flipX', 'flipY', 'ondraw', 'strokeColor', 'strokeWidth', 'radius', 'angle', 'alpha', 'size', 'file', 'visible'];

        this.pjs.OOP.forArr(params, e => {
            this[e] = {
                name: e,
                cb: j => {
                    ...
                    if (Array.isArray(this.object)) {
                        this.pjs.OOP.forArr(this.object, object => {
                            set(object.object);
                        });
                    } else {
                        set(this.object);
    ...
    mounted() {
        ...
        clearEvents(this.$refs.ce1);
        clearEvents(this.$refs.ce2);

        this.$refs.menu.style.display = 'flex';
        const filters = ['x', 'y', 'w', 'h', 'size', 'radius', 'file'];

        this.pjs.OOP.forArr(filters, e => {
            this.filters[e] = { filter: 'null', value: null, type: 'text' };
        });
    },
    computed: {
        objectsName() {
            return 'Обьекты ' + this.getObjects().length + ' из ' + this.objects.length;
        }
    },
    components: {
        vSection: __webpack_require__(/*! ./menu/section.vue */ 345),
        vSlider: __webpack_require__(/*! ./menu/slider.vue */ 348),
        vText: __webpack_require__(/*! ./menu/text.vue */ 351),
        vSelect: __webpack_require__(/*! ./menu/select.vue */ 354),
        vCheckbox: __webpack_require__(/*! ./menu/checkbox.vue */ 357),
        vButton: __webpack_require__(/*! ./menu/button.vue */ 360),
        vNumeric: __webpack_require__(/*! ./menu/numeric.vue */ 363),
        vTextarea: __webpack_require__(/*! ./menu/textarea.vue */ 366),
        vFilter: __webpack_require__(/*! ./menu/filter.vue */ 369)
    },
    methods: {
        menuClick() {
            if (this.showType === 'click') {
                this.style.right = this.style.right === 0 ? -380 + 'px' : 0;
            }
        },
        hoverIn() {
            if (this.showType === 'hover') {
                this.style.right = 0;
            }
        },
        hoverOut() {
            if (this.showType === 'hover') {
                this.style.right = -380 + 'px';
            }
        },
        getObjects() {
            if (this.enableFilters) {
                return this.objects.filter(e => {
                    ...
                    OOP.forEach(Object.keys(this.filters), e => res[e] = false);

                    OOP.forEach(Object.keys(res), e => {
                        const filter = this.filters[e].filter;
                        const value = this.filters[e].value;
                    ...
                    OOP.forEach(Object.values(res), e => {
                        if (!e) {
                            result = false;
                            return 'break';
                        }
    ...
    data() {
        return {
            ...
            menu: {
                name: 'Открывать меню',
                options: [{ value: 'click', name: 'При нажатии' }, { value: 'hover', name: 'При наведении' }],
                value: 'hover',
                update: e => {
                    this.showType = e;
                }
            ...
            isRun: {
                ...
                checked: true,
                cb: e => {
                    if (e) this.pjs.game.resume();else this.pjs.game.stop();
                }
            },

            setAllObjects: {
                name: 'Применить ко всем обьектам в списке',
                cb: () => {
                    this.updateObject(this.getObjects());
                }
            },
            fps: {
...
/* 345 */
/*!*****************************************!*\
  !*** ./src/components/menu/section.vue ***!
  \*****************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
var Component = __webpack_require__(/*! ../../../node_modules/vue-loader/lib/component-normalizer */ 21)(
  /* script */
  __webpack_require__(/*! !babel-loader!../../../node_modules/vue-loader/lib/selector?type=script&index=0!./section.vue */ 346),
  /* template */
  __webpack_require__(/*! !../../../node_modules/vue-loader/lib/template-compiler?id=data-v-224c29e7!../../../node_modules/vue-loader/lib/selector?type=template&index=0!./section.vue */ 347),
  /* scopeId */
  null,
  /* cssModules */
  null
)
Component.options.__file = "C:\\dev\\PointDebugger\\src\\components\\menu\\section.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-224c29e7", Component.options)
  } else {
    hotAPI.reload("data-v-224c29e7", Component.options)
  }
})()}
...
/* 346 */
/*!***************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/components/menu/section.vue ***!
  \***************************************************************************************************************************************/
/*! exports provided: default */
/*! all exports used */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted() {
        ...
        content.addEventListener("touchstart", d, !1);
        content.addEventListener("touchend", d, !1);
        content.addEventListener("touchmove", d, !1);
        content.addEventListener("mousedown", d, !1);
        content.addEventListener("mousepress", d, !1);
        content.addEventListener("mouseup", d, !1);
        content.addEventListener("mousemove", d, !1);
        content.addEventListener("keypress", d, !1);
        content.addEventListener("keydown", d, !1);
        content.addEventListener("keyup", d, !1);
        content.addEventListener("click", d, !1);
        content.addEventListener("wheel", d, !1);
        content.addEventListener("mousewheel", d, !1);
        content.addEventListener("contextmenu", d, !1);
        content.addEventListener("selectstart", d, !1);
        content.addEventListener("dragstart", d, !1);
        content.addEventListener("DOMMouseScroll", d, !1);
    },
    computed: {
        title() {
            // const hide = 'R0lGODlhBQAFAJEAAP////Pz8////////yH5BAEAAAIALAAAAAAFAAUAAAIIlGIWqMCbWAEAOw==';
            // const show = 'R0lGODlhBQAFAJEAAP////Pz8////////yH5BAEAAAIALAAAAAAFAAUAAAIIlI+hKgFxoCgAOw==';
            return {
                // background: `black url(data:image/png;base64,${this.show ? show : hide}) 6px 12px no-repeat`
            };
        },
        content() {
            return {
...
/* 347 */
/*!*******************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/template-compiler.js?id=data-v-224c29e7!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/components/menu/section.vue ***!
  \*******************************************************************************************************************************************************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-224c29e7", module.exports)
  }
}
...
var Component = __webpack_require__(/*! ../../../node_modules/vue-loader/lib/component-normalizer */ 21)(
  /* script */
  __webpack_require__(/*! !babel-loader!../../../node_modules/vue-loader/lib/selector?type=script&index=0!./slider.vue */ 349),
  /* template */
  __webpack_require__(/*! !../../../node_modules/vue-loader/lib/template-compiler?id=data-v-5aa4dacf!../../../node_modules/vue-loader/lib/selector?type=template&index=0!./slider.vue */ 350),
  /* scopeId */
  null,
  /* cssModules */
  null
)
Component.options.__file = "C:\\dev\\PointDebugger\\src\\components\\menu\\slider.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5aa4dacf", Component.options)
  } else {
    hotAPI.reload("data-v-5aa4dacf", Component.options)
  }
})()}
...
/* 349 */
/*!**************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/components/menu/slider.vue ***!
  \**************************************************************************************************************************************/
/*! exports provided: default */
/*! all exports used */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    props: ['cfg', 'change'],
    created() {
        this.cfg.min !== undefined && (this.min = this.cfg.min);
        this.cfg.max !== undefined && (this.max = this.cfg.max);
        this.cfg.step !== undefined && (this.step = this.cfg.step);
        this.cfg.value !== undefined && (this.value = this.cfg.value);
        this.cfg.input !== undefined && (this.input = this.cfg.input);
        this.cfg.text !== undefined && (this.text = this.cfg.text);
    },
    computed: {
        style() {
            return {
...
/* 350 */
/*!******************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/template-compiler.js?id=data-v-5aa4dacf!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/components/menu/slider.vue ***!
  \******************************************************************************************************************************************************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "pd_wrap pd_slider"
  }, [_c('div', {
    staticClass: "pd_name"
  }, [_vm._v(_vm._s(_vm.cfg.name))]), _vm._v(" "), _c('div', {
    staticClass: "pd_slider"
  }, [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
    ...
    staticClass: "pd_width",
    style: (_vm.style)
  })]), _vm._v(" "), (_vm.input) ? _c('div', {
    staticClass: "pd_numeric"
  }, [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-5aa4dacf", module.exports)
  }
}
...
var Component = __webpack_require__(/*! ../../../node_modules/vue-loader/lib/component-normalizer */ 21)(
  /* script */
  __webpack_require__(/*! !babel-loader!../../../node_modules/vue-loader/lib/selector?type=script&index=0!./text.vue */ 352),
  /* template */
  __webpack_require__(/*! !../../../node_modules/vue-loader/lib/template-compiler?id=data-v-6d8f9e9b!../../../node_modules/vue-loader/lib/selector?type=template&index=0!./text.vue */ 353),
  /* scopeId */
  null,
  /* cssModules */
  null
)
Component.options.__file = "C:\\dev\\PointDebugger\\src\\components\\menu\\text.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6d8f9e9b", Component.options)
  } else {
    hotAPI.reload("data-v-6d8f9e9b", Component.options)
  }
})()}
...
/* 352 */
/*!************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/components/menu/text.vue ***!
  \************************************************************************************************************************************/
/*! exports provided: default */
/*! all exports used */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted() {
        ...
        input.addEventListener("touchstart", d, !1);
        input.addEventListener("touchend", d, !1);
        input.addEventListener("touchmove", d, !1);
        input.addEventListener("mousedown", d, !1);
        input.addEventListener("mousepress", d, !1);
        input.addEventListener("mouseup", d, !1);
        input.addEventListener("mousemove", d, !1);
        input.addEventListener("keypress", d, !1);
        input.addEventListener("keydown", d, !1);
        input.addEventListener("keyup", d, !1);
        input.addEventListener("click", d, !1);
        input.addEventListener("wheel", d, !1);
        input.addEventListener("mousewheel", d, !1);
        input.addEventListener("contextmenu", d, !1);
        input.addEventListener("selectstart", d, !1);
        input.addEventListener("dragstart", d, !1);
        input.addEventListener("DOMMouseScroll", d, !1);
    },
    created() {
...
/* 353 */
/*!****************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/template-compiler.js?id=data-v-6d8f9e9b!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/components/menu/text.vue ***!
  \****************************************************************************************************************************************************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-6d8f9e9b", module.exports)
  }
}
...
/* 354 */
/*!****************************************!*\
  !*** ./src/components/menu/select.vue ***!
  \****************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
var Component = __webpack_require__(/*! ../../../node_modules/vue-loader/lib/component-normalizer */ 21)(
  /* script */
  __webpack_require__(/*! !babel-loader!../../../node_modules/vue-loader/lib/selector?type=script&index=0!./select.vue */ 355),
  /* template */
  __webpack_require__(/*! !../../../node_modules/vue-loader/lib/template-compiler?id=data-v-93fbdd2c!../../../node_modules/vue-loader/lib/selector?type=template&index=0!./select.vue */ 356),
  /* scopeId */
  null,
  /* cssModules */
  null
)
Component.options.__file = "C:\\dev\\PointDebugger\\src\\components\\menu\\select.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-93fbdd2c", Component.options)
  } else {
    hotAPI.reload("data-v-93fbdd2c", Component.options)
  }
})()}
...
/* 355 */
/*!**************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/components/menu/select.vue ***!
  \**************************************************************************************************************************************/
/*! exports provided: default */
/*! all exports used */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        name() {
            return this.cfg.options.find(e => e.value === this.value).name;
        }
    },
    data() {
        return {
...
/* 356 */
/*!******************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/template-compiler.js?id=data-v-93fbdd2c!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/components/menu/select.vue ***!
  \******************************************************************************************************************************************************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "pd_options"
  }, _vm._l((_vm.cfg.options), function(item) {
    return _c('div', {
      directives: [{
        name: "show",
        rawName: "v-show",
        value: (item.value !== _vm.value),
        expression: "item.value !== value"
      }],
      staticClass: "pd_option",
      on: {
        "click": function($event) {
          _vm.value = item.value, _vm.show = false
        }
      }
    }, [_vm._v("\n                " + _vm._s(item.name) + "\n            ")])
  }))])])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-93fbdd2c", module.exports)
  }
}
...
var Component = __webpack_require__(/*! ../../../node_modules/vue-loader/lib/component-normalizer */ 21)(
  /* script */
  __webpack_require__(/*! !babel-loader!../../../node_modules/vue-loader/lib/selector?type=script&index=0!./checkbox.vue */ 358),
  /* template */
  __webpack_require__(/*! !../../../node_modules/vue-loader/lib/template-compiler?id=data-v-bee6c19e!../../../node_modules/vue-loader/lib/selector?type=template&index=0!./checkbox.vue */ 359),
  /* scopeId */
  null,
  /* cssModules */
  null
)
Component.options.__file = "C:\\dev\\PointDebugger\\src\\components\\menu\\checkbox.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-bee6c19e", Component.options)
  } else {
    hotAPI.reload("data-v-bee6c19e", Component.options)
  }
})()}
...
/* 358 */
/*!****************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/components/menu/checkbox.vue ***!
  \****************************************************************************************************************************************/
/*! exports provided: default */
/*! all exports used */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    props: ['cfg'],
    created() {
        this.cfg.checked !== undefined && (this.checked = this.cfg.checked);
    },
    computed: {},
    data() {
        return {
...
/* 359 */
/*!********************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/template-compiler.js?id=data-v-bee6c19e!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/components/menu/checkbox.vue ***!
  \********************************************************************************************************************************************************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "pd_wrap pd_checkbox"
  }, [_c('div', {
    staticStyle: {
      "display": "flex"
    },
    ...
    staticClass: "pd_n"
  }, [_vm._v("no")])])]), _vm._v(" "), _vm._t("default")], 2)
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-bee6c19e", module.exports)
  }
}
...
/* 360 */
/*!****************************************!*\
  !*** ./src/components/menu/button.vue ***!
  \****************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
var Component = __webpack_require__(/*! ../../../node_modules/vue-loader/lib/component-normalizer */ 21)(
  /* script */
  __webpack_require__(/*! !babel-loader!../../../node_modules/vue-loader/lib/selector?type=script&index=0!./button.vue */ 361),
  /* template */
  __webpack_require__(/*! !../../../node_modules/vue-loader/lib/template-compiler?id=data-v-2e14f8a0!../../../node_modules/vue-loader/lib/selector?type=template&index=0!./button.vue */ 362),
  /* scopeId */
  null,
  /* cssModules */
  null
)
Component.options.__file = "C:\\dev\\PointDebugger\\src\\components\\menu\\button.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2e14f8a0", Component.options)
  } else {
    hotAPI.reload("data-v-2e14f8a0", Component.options)
  }
})()}
...
/* 361 */
/*!**************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/components/menu/button.vue ***!
  \**************************************************************************************************************************************/
/*! exports provided: default */
/*! all exports used */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 362 */
/*!******************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/template-compiler.js?id=data-v-2e14f8a0!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/components/menu/button.vue ***!
  \******************************************************************************************************************************************************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v(_vm._s(_vm.cfg.name))])])
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-2e14f8a0", module.exports)
  }
}
...
/* 363 */
/*!*****************************************!*\
  !*** ./src/components/menu/numeric.vue ***!
  \*****************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
var Component = __webpack_require__(/*! ../../../node_modules/vue-loader/lib/component-normalizer */ 21)(
  /* script */
  __webpack_require__(/*! !babel-loader!../../../node_modules/vue-loader/lib/selector?type=script&index=0!./numeric.vue */ 364),
  /* template */
  __webpack_require__(/*! !../../../node_modules/vue-loader/lib/template-compiler?id=data-v-0426720f!../../../node_modules/vue-loader/lib/selector?type=template&index=0!./numeric.vue */ 365),
  /* scopeId */
  null,
  /* cssModules */
  null
)
Component.options.__file = "C:\\dev\\PointDebugger\\src\\components\\menu\\numeric.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] numeric.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0426720f", Component.options)
  } else {
    hotAPI.reload("data-v-0426720f", Component.options)
  }
})()}
...
/* 364 */
/*!***************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/components/menu/numeric.vue ***!
  \***************************************************************************************************************************************/
/*! exports provided: default */
/*! all exports used */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data() {
        return {
            ...
            value: 'new text',
            input: () => {
                this.cfg.cb(parseFloat(this.value));
            },
            update(e) {
                if (!this.locked) {
...
/* 365 */
/*!*******************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/template-compiler.js?id=data-v-0426720f!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/components/menu/numeric.vue ***!
  \*******************************************************************************************************************************************************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-0426720f", module.exports)
  }
}
...
/* 366 */
/*!******************************************!*\
  !*** ./src/components/menu/textarea.vue ***!
  \******************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
var Component = __webpack_require__(/*! ../../../node_modules/vue-loader/lib/component-normalizer */ 21)(
  /* script */
  __webpack_require__(/*! !babel-loader!../../../node_modules/vue-loader/lib/selector?type=script&index=0!./textarea.vue */ 367),
  /* template */
  __webpack_require__(/*! !../../../node_modules/vue-loader/lib/template-compiler?id=data-v-e826b1b0!../../../node_modules/vue-loader/lib/selector?type=template&index=0!./textarea.vue */ 368),
  /* scopeId */
  null,
  /* cssModules */
  null
)
Component.options.__file = "C:\\dev\\PointDebugger\\src\\components\\menu\\textarea.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-e826b1b0", Component.options)
  } else {
    hotAPI.reload("data-v-e826b1b0", Component.options)
  }
})()}
...
/* 367 */
/*!****************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/components/menu/textarea.vue ***!
  \****************************************************************************************************************************************/
/*! exports provided: default */
/*! all exports used */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 368 */
/*!********************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/template-compiler.js?id=data-v-e826b1b0!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/components/menu/textarea.vue ***!
  \********************************************************************************************************************************************************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-e826b1b0", module.exports)
  }
}
...
/* 369 */
/*!****************************************!*\
  !*** ./src/components/menu/filter.vue ***!
  \****************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
var Component = __webpack_require__(/*! ../../../node_modules/vue-loader/lib/component-normalizer */ 21)(
  /* script */
  __webpack_require__(/*! !babel-loader!../../../node_modules/vue-loader/lib/selector?type=script&index=0!./filter.vue */ 370),
  /* template */
  __webpack_require__(/*! !../../../node_modules/vue-loader/lib/template-compiler?id=data-v-87b7ec34!../../../node_modules/vue-loader/lib/selector?type=template&index=0!./filter.vue */ 371),
  /* scopeId */
  null,
  /* cssModules */
  null
)
Component.options.__file = "C:\\dev\\PointDebugger\\src\\components\\menu\\filter.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-87b7ec34", Component.options)
  } else {
    hotAPI.reload("data-v-87b7ec34", Component.options)
  }
})()}
...
/* 370 */
/*!**************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/components/menu/filter.vue ***!
  \**************************************************************************************************************************************/
/*! exports provided: default */
/*! all exports used */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    props: ['name', 'filter', 'saveFilter'],
    methods: {
        save() {
            this.saveFilter(this.name, this.currentFilter, this.value);
        }
    },
    mounted() {
        const input = this.$refs.input;
...
/* 371 */
/*!******************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/template-compiler.js?id=data-v-87b7ec34!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/components/menu/filter.vue ***!
  \******************************************************************************************************************************************************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "pd_wrap pd_filter"
  }, [_c('div', {
    staticClass: "pd_name"
  }, [_vm._v(_vm._s(_vm.name))]), _vm._v(" "), _c('div', {
    staticClass: "pd_select"
  }, [_c('div', {
    class: {
      active: _vm.currentFilter === 'null'
    },
    on: {
      "click": function($event) {
        _vm.currentFilter = 'null', _vm.save()
      }
    }
  }, [_vm._v("\n            null\n        ")]), _vm._v(" "), _c('div', {
    class: {
      active: _vm.currentFilter === '<'
    },
    on: {
      "click": function($event) {
        _vm.currentFilter = '<', _vm.save()
      }
    }
  }, [_vm._v("\n            <\n        ")]), _vm._v(" "), _c('div', {
    class: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-87b7ec34", module.exports)
  }
}
...
/* 372 */
/*!***********************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/template-compiler.js?id=data-v-c86c5bde!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/components/menu.vue ***!
  \***********************************************************************************************************************************************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "pd_button",
    on: {
      "click": _vm.menuClick
    }
  }, [_c('div', {
    staticClass: "pdTitle"
  }, [_vm._v("Меню")])]), _vm._v(" "), _c('div', {
    staticClass: "pd_container"
  }, [_c('div', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (!_vm.object && !_vm.isShowFilters),
      expression: "!object && !isShowFilters"
    }]
  }, [_c('v-select', {
    attrs: {
      "cfg": _vm.menu
    ...
    ref: "isEnableFilters",
    attrs: {
      "cfg": _vm.isEnableFilters
    }
  }, [_c('div', {
    class: {
      pd_isShowFilter: true, disabled: !_vm.enableFilters
    },
    on: {
      "click": function($event) {
        _vm.enableFilters && (_vm.isShowFilters = true)
      }
    }
  }, [_vm._v("Фильтры")])]), _vm._v(" "), _c('v-button', {
    attrs: {
      "cfg": _vm.setAllObjects
    }
  }), _vm._v(" "), _c('div', {
    staticClass: "pd_section"
  }, [_c('div', {
    staticClass: "pd_title"
  }, [_vm._v(_vm._s(_vm.objectsName))]), _vm._v(" "), _c('div', {
    ref: "ce1",
    staticClass: "pd_content",
    staticStyle: {
  ...
  }, _vm._l((_vm.getObjects()), function(item) {
    return _c('v-button', {
      attrs: {
        "name": item.name,
        "cfg": item.cfg,
        "hover": function () {
          _vm.hover(item.object)
        }
      }
    })
  }))])], 1), _vm._v(" "), _c('div', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.isShowFilters),
      expression: "isShowFilters"
    }]
  }, [_c('div', {
    staticClass: "pd_return",
    on: {
      "click": function($event) {
        if (!('button' in $event) && _vm._k($event.keyCode, "left", 37, $event.key)) { return null; }
        if ('button' in $event && $event.button !== 0) { return null; }
        _vm.isShowFilters = false
      }
    }
  }, [_vm._v("\n                Назад\n            ")]), _vm._v(" "), _c('div', {
    staticClass: "pd_section"
    ...
    return _c('v-filter', {
      attrs: {
        "name": key,
        "filter": _vm.filters[key],
        "saveFilter": _vm.saveFilter
      }
    })
  }))])]), _vm._v(" "), _c('div', {
    directives: [{
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-c86c5bde", module.exports)
  }
}
...
/* 373 */
/*!************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/template-compiler.js?id=data-v-80fb1d46!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/components/stats.vue ***!
  \************************************************************************************************************************************************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-80fb1d46", module.exports)
  }
}
